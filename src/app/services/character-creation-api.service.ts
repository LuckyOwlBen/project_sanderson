...
export class CharacterCreationApiService {
  ...
  updateAncestry(id: string, ancestry: string): Observable<AncestryUpdateResponse> {
    return this.http.post<AncestryUpdateResponse>(`${this.charactersUrl}/${id}/ancestry`, {
      ancestry,
    });
  }
  ...
  updateName(id: string, name: string, level?: number): Observable<CharacterNameUpdateResponse> {
    return this.http.post<CharacterNameUpdateResponse>(`${this.charactersUrl}/${id}/name`, {
      name,
      level,
    });
  }
  ...
  updateCultures(id: string, cultures: any[]): Observable<CultureUpdateResponse> {
    return this.http.post<CultureUpdateResponse>(`${this.charactersUrl}/${id}/cultures`, {
      cultures,
    });
  }
  ...
  updateAttributes(
    id: string,
    attributes: Record<string, number>
  ): Observable<AttributeUpdateResponse> {
    return this.http.post<AttributeUpdateResponse>(`${this.charactersUrl}/${id}/attributes`, {
      attributes,
    });
  }
  ...
  updateExpertises(id: string, selectedExpertises: any[]): Observable<ExpertiseUpdateResponse> {
    return this.http.post<ExpertiseUpdateResponse>(`${this.charactersUrl}/${id}/expertises`, {
      selectedExpertises,
    });
  }
}
