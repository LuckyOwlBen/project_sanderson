  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <div class="operation-type">
        <label>
          <input type="radio" name="operation" value="add" [(ngModel)]="operation" (change)="updatePreview()">
          <span>Give Money (+)</span>
        </label>
        <label>
          <input type="radio" name="operation" value="set" [(ngModel)]="operation" (change)="updatePreview()">
      ...
      <mat-card class="preview-card" *ngIf="amount">
        <mat-card-content>
          ...
          <div class="preview-row operation" [class.add]="operation === 'add'" [class.set]="operation === 'set'">
      ...
      <div class="warning-box" *ngIf="amount && amount > 10000">
        ...
        <div>
          ...
          <p>You are granting {{ amount }} mk, which is a large amount. Please confirm this is intentional.</p>
        </div>
      </div>
    </mat-dialog-content>
