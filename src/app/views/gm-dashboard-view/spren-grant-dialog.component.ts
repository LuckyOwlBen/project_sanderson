  ...
  template: `
    ...
    <mat-dialog-content>
      <p class="dialog-description">
        Select a Radiant Order to grant this character. They will bond the corresponding spren and
        unlock the Order's tier 0 talent.
      </p>

      <div class="orders-list">
        <div
          *ngFor="let orderEntry of getOrders()"
          class="order-option"
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-raised-button color="primary" (click)="onGrant()" [disabled]="!selectedOrder">
