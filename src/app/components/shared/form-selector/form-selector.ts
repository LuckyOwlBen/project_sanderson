  ...
  template: `
    <div class="form-selector">
      <div class="form-field">
        ...
        >
          <option value="" data-testid="no-form-option">No Active Form</option>
      ...
      <div *ngIf="availableForms.length === 0 && character" class="no-forms-message">
        ...
        <p class="debug-info">
          <small>Unlocked Singer forms: {{ character.unlockedSingerForms.length }}</small
          ><br />
      ...
      <div *ngIf="selectedFormId && activeFormInfo" class="active-form-info">
        ...
        <div
          *ngIf="activeFormInfo.effects && activeFormInfo.effects.length > 0"
          class="form-effects"
        >
          <h5>Effects:</h5>
          <ul>
    ...
    `
      ...
      .active-form-info {
        ...
        background: linear-gradient(
          135deg,
          rgba(74, 179, 232, 0.08) 0%,
          rgba(74, 179, 232, 0.03) 100%
        );
        border-radius: 12px;
...
export class FormSelectorComponent implements OnInit, OnDestroy {
  ...
  constructor(private characterState: CharacterStateService, private cdr: ChangeDetectorRef) {}
