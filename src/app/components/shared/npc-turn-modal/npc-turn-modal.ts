...
@Component({
  ...
  template: `
    <div class="npc-turn-dialog">
      ...
      <mat-dialog-content>
        <div class="round-info">Round {{ data.round }}</div>
        ...
        <div class="instructions">
          ...
          <div>
            ...
            <p>
              Resolve all NPC/enemy turns for this phase, then click the button below to continue.
            </p>
          </div>
        </div>
        ...
        <div class="action-info">
          ...
          <span
            >NPCs in this phase have <strong>{{ getActionCount() }} actions</strong> + 1
            reaction</span
          >
        </div>
      </mat-dialog-content>
