...
export const RADIANT_UNIVERSAL_ABILITIES: UniversalAbility[] = [
  {
    ...
    description:
      "You draw Stormlight into yourself from infused spheres within 5 feet of you; if you have enough spheres, you recover Investiture up to your maximum. In normal times, dun spheres can be readily exchanged for infused spheres, and highstorms occur regularly. If you have at least three times as many marks as your Investiture total, it's assumed you have enough infused spheres to draw from. In some situations, the GM may ask you to keep track of how many of your spheres are infused. On those occasions, you recover 1 Investiture for each infused mark or broam you drain.",
    actionCost: 2,
  ...
  },
  {
    ...
    name: 'Enhance',
    description:
      'Spend 1 Investiture to become Enhanced [Strength +1] and Enhanced [Speed +1] until the end of your next turn. At the end of that turn and each of your turns thereafter, you can spend 1 Investiture as a free action to maintain these conditions until the end of your next turn.',
    actionCost: 1,
    category: AbilityCategory.RADIANT_UNIVERSAL,
    source: 'First Ideal',
    resourceCost: {
  ...
  },
  {
    ...
    name: 'Regenerate',
    description:
      "Spend 1 Investiture to recover health equal to 1d6 + your current tier; for example, a tier 2 character recovers 1d6 + 2 health. You can use this free action even if you're Unconscious or otherwise prevented from using actions.",
    actionCost: 'free',
    category: AbilityCategory.RADIANT_UNIVERSAL,
    source: 'First Ideal',
    resourceCost: {
...
export const SINGER_FORMS: UniversalAbility[] = [
  // Default Form
  {
    ...
    name: 'Dullform',
    description:
      'The default form of Singers, conferring no particular advantages or disadvantages. This is the form Singers are born into and return to when they have no other form active.',
    actionCost: 'passive',
  ...
  // Basic Forms (available through Forms of Finesse)
  {
    ...
    name: 'Nimbleform',
    description:
      'A form focused on agility and mental acuity. While in nimbleform, you gain enhanced speed and focus.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Finesse',
    effects: ['Speed +1', 'Focus +2'],
  },
  {
    id: 'artform',
    name: 'Artform',
    description:
      'A form attuned to creativity and artistic expression. While in artform, you gain enhanced awareness and expertise in artistic endeavors.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Finesse',
    effects: [
  ...
  // Wisdom Forms (available through Forms of Wisdom)
  {
    ...
    name: 'Meditationform',
    description:
      'A form focused on inner peace and supporting others. While in meditationform, you can aid allies without expending focus.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Wisdom',
    effects: ['Presence +1', 'Can aid without spending focus'],
  },
  {
    id: 'scholarform',
    name: 'Scholarform',
    description:
      'A form dedicated to learning and intellectual pursuits. While in scholarform, you gain enhanced intellect and temporarily acquire new knowledge.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Wisdom',
    effects: [
  ...
  // Resolve Forms (available through Forms of Resolve)
  {
    ...
    name: 'Warform',
    description:
      'A form built for combat and physical prowess. While in warform, you gain enhanced strength and natural armor.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Resolve',
    effects: ['Strength +1', 'Physical Deflect +1'],
  },
  {
    id: 'workform',
    name: 'Workform',
    description:
      'A form suited for labor and endurance. While in workform, you can push through exhaustion and blend in with parshmen.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Resolve',
    effects: ['Willpower +1', 'Ignore Exhausted condition', 'Can disguise yourself as parshman'],
  },
  ...
  // Destruction Forms (available through Forms of Destruction - requires Voidspren bond)
  {
    ...
    name: 'Direform',
    description:
      'A powerful combat form granted by bonding a Voidspren. While in direform, you become a formidable physical force.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
  ...
  },
  {
    ...
    name: 'Stormform',
    description:
      'A devastating form that channels the power of storms. While in stormform, you can unleash lightning against your foes.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Destruction (Voidspren)',
    effects: [
  ...
  // Expansion Forms (available through Forms of Expansion - requires Voidspren bond)
  {
    ...
    name: 'Envoyform',
    description:
      'A diplomatic form enhanced by Voidspren bond. While in envoyform, you excel at persuasion and understanding.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
  ...
  },
  {
    ...
    name: 'Relayform',
    description:
      'A form attuned to speed and agility. While in relayform, you move with supernatural swiftness.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Expansion (Voidspren)',
    effects: [
  ...
  // Mystery Forms (available through Forms of Mystery - requires Voidspren bond)
  {
    ...
    name: 'Decayform',
    description:
      'A sinister form that spreads entropy and prevents healing. While in decayform, you can suppress recovery.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
  ...
  },
  {
    ...
    name: 'Nightform',
    description:
      'A mysterious form that grants visions of possible futures. While in nightform, you see glimpses of what may come.',
    actionCost: 'passive',
    category: AbilityCategory.OTHER,
    source: 'Singer Forms - Forms of Mystery (Voidspren)',
    effects: [
...
export const SINGER_FORM_ABILITIES: UniversalAbility[] = [
  {
    ...
    description:
      'Channel the power of the storm through your body to strike distant foes with lightning. This ability is only available while in stormform.',
    actionCost: 2,
    category: AbilityCategory.OTHER,
    source: 'Stormform',
    resourceCost: {
    ...
    limitations: ['Only usable while in stormform', 'Requires 1 focus or 1 Investiture'],
  },
  {
    id: 'change_form',
    name: 'Change Form',
    description:
      'During a highstorm, you can change into dullform, mateform, or another one of your known singer forms. The transformation takes time and requires the chaotic energy of a highstorm.',
    actionCost: 3,
    category: AbilityCategory.OTHER,
